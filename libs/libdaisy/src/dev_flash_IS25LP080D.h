...
#define IS25LP080D_SR_SRWREN                   ((uint8_t)0x80)    /*!< Status register write enable/disable */
#define IS25LP080D_SR_QE						  ((uint8_t)0x40)

	                  /* Non volatile Configuration Register */
#define IS25LP080D_NVCR_NBADDR                 ((uint16_t)0x0001) /*!< 3-bytes or 4-bytes addressing */
#define IS25LP080D_NVCR_SEGMENT                ((uint16_t)0x0002) /*!< Upper or lower 128Mb segment selected by default */
...
#define IS25LP080D_NVCR_DTRP                   ((uint16_t)0x0020) /*!< Double transfer rate protocol */
#define IS25LP080D_NVCR_ODS                    ((uint16_t)0x01C0) /*!< Output driver strength */
#define IS25LP080D_NVCR_XIP                    ((uint16_t)0x0E00) /*!< XIP mode at power-on reset */
#define IS25LP080D_NVCR_NB_DUMMY               ((uint16_t)0xF000) /*!< Number of dummy clock cycles */

	                  /* Volatile Configuration Register */
#define IS25LP080D_VCR_WRAP                    ((uint8_t)0x03)    /*!< Wrap */
#define IS25LP080D_VCR_XIP                     ((uint8_t)0x08)    /*!< XIP */
#define IS25LP080D_VCR_NB_DUMMY                ((uint8_t)0xF0)    /*!< Number of dummy clock cycles */

	                  /* Extended Address Register */
#define IS25LP080D_EAR_HIGHEST_SE              ((uint8_t)0x03)    /*!< Select the Highest 128Mb segment */
#define IS25LP080D_EAR_THIRD_SEG               ((uint8_t)0x02)    /*!< Select the Third 128Mb segment */
#define IS25LP080D_EAR_SECOND_SEG              ((uint8_t)0x01)    /*!< Select the Second 128Mb segment */
#define IS25LP080D_EAR_LOWEST_SEG              ((uint8_t)0x00)    /*!< Select the Lowest 128Mb segment (default) */

	                  /* Enhanced Volatile Configuration Register */
#define IS25LP080D_EVCR_ODS                    ((uint8_t)0x07)    /*!< Output driver strength */
#define IS25LP080D_EVCR_RH                     ((uint8_t)0x10)    /*!< Reset/hold */
#define IS25LP080D_EVCR_DTRP                   ((uint8_t)0x20)    /*!< Double transfer rate protocol */
#define IS25LP080D_EVCR_DUAL                   ((uint8_t)0x40)    /*!< Dual I/O protocol */
#define IS25LP080D_EVCR_QUAD                   ((uint8_t)0x80)    /*!< Quad I/O protocol */

	                  /* Flag Status Register */
#define IS25LP080D_FSR_NBADDR                  ((uint8_t)0x01)    /*!< 3-bytes or 4-bytes addressing */
...
#define IS25LP080D_FSR_READY                   ((uint8_t)0x80)    /*!< Ready or command in progress */
